...
public class Return implements Instruction {
	...
	public boolean checkType() {
		...
		if(this.value.getType().compatibleWith(AtomicType.VoidType) || this.value.getType().compatibleWith(AtomicType.ErrorType)) {
			Logger.error("The return value must be of a non-void type.");
			return false;
		} else {
